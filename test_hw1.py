import pytest
from constants import PARAMS_FOR_AUTH
from selenium.webdriver import Chrome
from selenium.webdriver.common.by import By
from functions import wait_until_clickable, wait_until_url_to_be
...
class TestAuthorizationClass:
    ...
    @pytest.mark.parametrize("email,password", PARAMS_FOR_AUTH, ids=["email is empty", "password is empty",
    ...
    def test_login_negative(self, email, password):
        with Chrome() as browser:
            ...
            wait_until_clickable(browser, (By.CLASS_NAME, 'button')).click()
            assert wait_until_url_to_be(browser, 'https://qastand.valhalla.pw/login'), "Вы смогли авторизоватьяся"
